                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 mt-1">{{ $jobVacancy->type }}</p>
                            </div>
                        </div>
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="md:col-span-2">
                            ...
                            <p class="mt-3 text-gray-700 leading-relaxed">{{ $jobVacancy->description }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-400 uppercase">Location</p>
                            <p class="mt-2 text-gray-700">{{ $jobVacancy->location }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-400 uppercase">Job Type</p>
                            <p class="mt-2 text-gray-700">{{ $jobVacancy->type }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-400 uppercase">Salary</p>
                            <p class="mt-2 text-gray-700">${{ $jobVacancy->salary }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-400 uppercase">View Count</p>
                            <p class="mt-2 text-gray-700">{{ $jobVacancy->veiw_count }}</p>
                        </div>
                        <div class="md:col-span-2">
                            <p class="text-sm font-semibold text-gray-400 uppercase">Required Skills</p>
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-400 uppercase">Company</p>
                            <p class="mt-2 text-gray-700">{{ $jobVacancy->company->name ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-400 uppercase">Category</p>
                            <p class="mt-2 text-gray-700">{{ $jobVacancy->category->name ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <p class="text-sm font-semibold text-gray-400 uppercase">Created At</p>
                            <p class="mt-2 text-gray-700">{{ $jobVacancy->created_at->format('d M Y') }}</p>
                        </div>
                    </div>

                    <!-- ACTIONS - RIGHT ALIGNED (NO RESTORE) -->
                    ...
                    <div x-data="{ openApplications: false }" class="mt-12 border-t pt-8">
                        <button @click="openApplications = !openApplications"
                            class="relative pb-3 text-lg font-semibold transition"
                            :class="openApplications ? 'text-blue-600' : 'text-gray-500 hover:text-gray-700'">
                            Applications
                            <div x-show="openApplications" x-transition class="absolute left-0 bottom-0 w-full h-1 bg-blue-600 rounded-full"></div>
                        </button>
                        ...
                        <div x-show="openApplications" x-transition class="mt-6 overflow-x-auto">
                            <table class="w-full border border-gray-200 rounded-xl overflow-hidden">
                                <thead class="bg-gray-100">
                                    <tr>
                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Applicant</th>
                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Email</th>
                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Status</th>
                                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Applied At</th>
