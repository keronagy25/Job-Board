...
class JobCategoryController extends Controller
{
    ...
    public function store(JobCategoryCreateRequest $request)
    {
        ...
        return redirect()->route('job-categorios.index')->with('success', 'Job category created successfully!.');
    }
    ...
    public function update(JobCategoryCreateRequest $request, string $id)
    {
        ...
        return redirect()->route('job-categorios.index')->with('success', 'Job category updated successfully!.');
    }
    ...
    public function destroy(string $id)
    {
        $jobCategory = JobCategory::findOrFail($id);
        $jobCategory->delete();
        return redirect()->route('job-categorios.index')->with('success', 'Job category archived successfully!.');
    }
    ...
    public function restore(string $id)
    {
        ...
        $jobCategory->restore();
        return redirect()->route('job-categorios.index',['archived'=>'true'])->with('success', 'Job category restored successfully!.');
    }
}
